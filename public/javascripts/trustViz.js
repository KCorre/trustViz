  ...
  nodeEnter.append("circle")
	  ...
	  .on("mouseover", function(d) {      
            ...
            div.html(d.value + " bits")
            	.style("left", d.x + Math.sqrt((d.rNorm*d.rNorm)/2)+ 2* rOperator + margin.left + 2 + 200+"px")     
	  ...
	  .on("dblclick",function(d){
		  ...
		  if(d.children == undefined && d.aux_children == undefined){
          	...
          	divData.transition()        
            	.duration(200)      
            	.style("opacity", .9)
          	divData.style("left", d.x + Math.sqrt((d.rNorm*d.rNorm)/2)+ 2* rOperator + margin.left + 2 +200+"px")     
            	.style("top", d.y + Math.sqrt((d.rNorm*d.rNorm)/2) + margin.top +"px")
